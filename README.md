...
<p align="center">
  🌊 You've arrived at <strong>Rio</strong>, an easy to use framework for creating websites and
  apps.<br><br>
  🐍 Rio is based <strong>entirely on Python</strong>. You <strong>won't need a single line of HTML, CSS, or
