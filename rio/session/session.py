...
from . import refresh_mixin, rpc_mixin
from .. import (
    app_server,
    assets,
    data_models,
...
from ..components import root_components
from ..components.icon import is_icon_fill
from ..data_models import UnittestComponentLayout
...
from ..transports import AbstractTransport
...
class Session(
    refresh_mixin.SessionRefreshMixin,
    rpc_mixin.SessionRpcMixin,
    metaclass=RioDataclassMeta,
):
    """
    ...
    def __init__(
        ...
        refresh_mixin.SessionRefreshMixin.__init__(self)
        rpc_mixin.SessionRpcMixin.__init__(self, transport)
...
"""
    ...
    async def set_clipboard(self, text: str) -> None:
        ...
        if self.running_in_window:
            ...
            except rpc_mixin.RpcError as e:
